...
def generate_rollout(args, rollout_id, data_buffer, evaluation=False):
    ...
    global TOKENIZER, PROCESSOR, MASK_GENERATOR, SAMPLE_PRINTED, CONSTANT_SAMPLE
    ...
    if CONSTANT_SAMPLE is None:
        for i in range(args.constant_rollout_skip_batches):
            _ = data_buffer.get_samples(args.rollout_batch_size)
        samples = data_buffer.get_samples(args.rollout_batch_size)
        CONSTANT_SAMPLE = samples
    else:
        samples = CONSTANT_SAMPLE
